...
func handleSessionGitLLMStub(t *testing.T, wire localRPCRequest, opCount int) localRPCResponse {
	...
	case "log_stream":
		return handleLogStreamDispatchForTest(t, wire, opCount)
	case "llm_invoke":
