...
type brokerLocalAPI interface {
	...
	DependencyCacheHandoff(context.Context, brokerapi.DependencyCacheHandoffRequest) (brokerapi.DependencyCacheHandoffResponse, *brokerapi.ErrorResponse)
	...
	AuditRecordInclusionGet(context.Context, brokerapi.AuditRecordInclusionGetRequest) (brokerapi.AuditRecordInclusionGetResponse, *brokerapi.ErrorResponse)
	AuditEvidenceSnapshotGet(context.Context, brokerapi.AuditEvidenceSnapshotGetRequest) (brokerapi.AuditEvidenceSnapshotGetResponse, *brokerapi.ErrorResponse)
	AuditEvidenceRetentionReview(context.Context, brokerapi.AuditEvidenceRetentionReviewRequest) (brokerapi.AuditEvidenceRetentionReviewResponse, *brokerapi.ErrorResponse)
	AuditEvidenceBundleManifestGet(context.Context, brokerapi.AuditEvidenceBundleManifestGetRequest) (brokerapi.AuditEvidenceBundleManifestGetResponse, *brokerapi.ErrorResponse)
	AuditEvidenceBundleExport(context.Context, brokerapi.AuditEvidenceBundleExportRequest) ([]brokerapi.AuditEvidenceBundleExportEvent, *brokerapi.ErrorResponse)
	AuditEvidenceBundleOfflineVerify(context.Context, brokerapi.AuditEvidenceBundleOfflineVerifyRequest) (brokerapi.AuditEvidenceBundleOfflineVerifyResponse, *brokerapi.ErrorResponse)
