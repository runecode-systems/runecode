...
func TestLiveIPCCommandClassificationIncludesSessionCommands(t *testing.T) {
	...
	assertCommandClassifications(t, handlers, []commandClassificationExpectation{
		...
		{command: "audit-evidence-snapshot-get", mode: brokerCommandAPIModeLiveIPC, requiresStore: false},
		{command: "audit-evidence-retention-review", mode: brokerCommandAPIModeLiveIPC, requiresStore: false},
		{command: "audit-evidence-bundle-manifest-get", mode: brokerCommandAPIModeLiveIPC, requiresStore: false},
		{command: "audit-evidence-bundle-export", mode: brokerCommandAPIModeLiveIPC, requiresStore: false},
		{command: "audit-evidence-bundle-offline-verify", mode: brokerCommandAPIModeLiveIPC, requiresStore: false},
