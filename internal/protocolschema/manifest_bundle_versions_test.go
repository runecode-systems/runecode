...
func localBrokerSchemaVersions() map[string]string {
	return map[string]string{
		...
		"runecode.protocol.v0.AuditEvidenceSnapshot":                    "0.1.0",
		"runecode.protocol.v0.AuditEvidenceSnapshotGetRequest":          "0.1.0",
		"runecode.protocol.v0.AuditEvidenceSnapshotGetResponse":         "0.1.0",
		"runecode.protocol.v0.AuditEvidenceRetentionReviewRequest":      "0.1.0",
		"runecode.protocol.v0.AuditEvidenceRetentionReviewResponse":     "0.1.0",
		"runecode.protocol.v0.AuditEvidenceBundleManifest":              "0.1.0",
		"runecode.protocol.v0.AuditEvidenceBundleManifestGetRequest":    "0.1.0",
		"runecode.protocol.v0.AuditEvidenceBundleManifestGetResponse":   "0.1.0",
		"runecode.protocol.v0.AuditEvidenceBundleExportRequest":         "0.1.0",
		"runecode.protocol.v0.AuditEvidenceBundleExportEvent":           "0.1.0",
		"runecode.protocol.v0.AuditEvidenceBundleOfflineVerifyRequest":  "0.1.0",
		"runecode.protocol.v0.AuditEvidenceBundleOfflineVerification":   "0.1.0",
		"runecode.protocol.v0.AuditEvidenceBundleOfflineVerifyResponse": "0.1.0",
