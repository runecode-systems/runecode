...
func brokerErrorRegistryCodes() []string {
	return []string{
		...
		"broker_dependency_audit_ledger_unavailable",
		"broker_dependency_audit_anchor_signer_unavailable",
		"broker_dependency_audit_anchor_presence_mode_unavailable",
		"broker_dependency_audit_anchor_presence_challenge_unavailable",
		"broker_dependency_audit_anchor_presence_token_unavailable",
		"broker_dependency_audit_anchor_action_unavailable",
		"broker_dependency_audit_anchor_result_invalid",
		"broker_dependency_audit_readiness_unavailable",
		"broker_not_found_artifact",
		"broker_not_found_run",
		"broker_not_found_approval",
		"broker_not_found_session",
		"broker_not_found_audit_record",
...
func assertPolicyRegistryCodes(t *testing.T) {
	...
	assertRegistryContainsCodes(t, policyRegistry,
		...
		"deny_container_acknowledgment_required",
...
func assertAuditRegistryCodes(t *testing.T) {
	...
	assertRegistryContainsCodes(t, auditRegistry,
		...
		"secrets_lease_renewed",
		"secrets_lease_denied",
		"secrets_lease_expired",
