...
func gitRemotePreparedRecordFixture(preparedID string) GitRemotePreparedMutationRecord {
	return GitRemotePreparedMutationRecord{
		...
		Provider:                 "github",
		DestinationRef:           "github.com/runecode-systems/repo",
		RequestKind:              "git_ref_update",
		TypedRequestSchemaID:     "runecode.protocol.v0.GitRefUpdateRequest",
		TypedRequestSchemaVer:    "0.1.0",
		TypedRequest:             map[string]any{"schema_id": "runecode.protocol.v0.GitRefUpdateRequest", "schema_version": "0.1.0", "request_kind": "git_ref_update", "destination_ref": "github.com/runecode-systems/repo"},
		...
		DerivedSummary:           map[string]any{"schema_id": "runecode.protocol.v0.GitRemoteMutationDerivedSummary", "schema_version": "0.1.0", "repository_identity": "https://github.com/runecode-systems/repo", "target_refs": []any{"refs/heads/main"}, "referenced_patch_artifact_digests": []any{}, "expected_result_tree_hash": map[string]any{"hash_alg": "sha256", "hash": testDigest("7")[7:]}},
