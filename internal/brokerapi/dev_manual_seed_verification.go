...
func devManualVerificationReport() trustpolicy.AuditVerificationReportPayload {
	return trustpolicy.AuditVerificationReportPayload{SchemaID: trustpolicy.AuditVerificationReportSchemaID, SchemaVersion: trustpolicy.AuditVerificationReportSchemaVersion, VerifiedAt: "2026-03-13T12:30:00Z", VerificationScope: trustpolicy.AuditVerificationScope{ScopeKind: trustpolicy.AuditVerificationScopeSegment, LastSegmentID: "segment-000001"}, CryptographicallyValid: false, HistoricallyAdmissible: false, CurrentlyDegraded: true, IntegrityStatus: trustpolicy.AuditVerificationStatusFailed, AnchoringStatus: trustpolicy.AuditVerificationStatusDegraded, StoragePostureStatus: trustpolicy.AuditVerificationStatusOK, SegmentLifecycleStatus: trustpolicy.AuditVerificationStatusOK, DegradedReasons: []string{trustpolicy.AuditVerificationReasonAnchorReceiptMissing}, HardFailures: []string{trustpolicy.AuditVerificationReasonDetachedSignatureInvalid}, Findings: []trustpolicy.AuditVerificationFinding{{Code: trustpolicy.AuditVerificationReasonDetachedSignatureInvalid, Dimension: trustpolicy.AuditVerificationDimensionIntegrity, Severity: trustpolicy.AuditVerificationSeverityError, Message: "dev manual seed uses synthetic envelopes and does not represent verified production audit state", SegmentID: "segment-000001"}, {Code: trustpolicy.AuditVerificationReasonAnchorReceiptMissing, Dimension: trustpolicy.AuditVerificationDimensionAnchoring, Severity: trustpolicy.AuditVerificationSeverityWarning, Message: "dev manual seed does not include external anchor receipts", SegmentID: "segment-000001"}}, Summary: "synthetic dev seed; not a verified production audit posture"}
}
