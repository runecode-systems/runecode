...
func (s *Service) persistApprovalRecord(rec approvalRecord) error {
	stored := artifacts.ApprovalRecord{
		...
		ScopeDigest:            rec.Summary.ScopeDigest,
		ArtifactSetDigest:      rec.Summary.ArtifactSetDigest,
		DiffDigest:             rec.Summary.DiffDigest,
		SummaryPreviewDigest:   rec.Summary.SummaryPreviewDigest,
		ConsumedActionHash:     rec.Summary.ConsumedActionHash,
		ConsumedArtifactDigest: rec.Summary.ConsumedArtifactDigest,
		ConsumptionLinkDigest:  rec.Summary.ConsumptionLinkDigest,
