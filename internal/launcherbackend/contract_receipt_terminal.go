...
func normalizeReceiptCoreFields(receipt *BackendLaunchReceipt) {
	...
	receipt.ProvisioningPosture = normalizeProvisioningPosture(receipt.ProvisioningPosture)
	receipt.HypervisorImplementation = normalizeHypervisorImplementation(receipt.HypervisorImplementation)
	receipt.AccelerationKind = normalizeAccelerationKind(receipt.AccelerationKind)
	receipt.TransportKind = normalizeTransportKind(receipt.TransportKind)
