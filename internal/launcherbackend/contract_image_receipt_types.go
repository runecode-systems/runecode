...
type BackendLaunchReceipt struct {
	...
	AttestationEvidenceSourceKind       string                      `json:"attestation_evidence_source_kind,omitempty"`
	AttestationMeasurementProfile       string                      `json:"attestation_measurement_profile,omitempty"`
	AttestationFreshnessMaterial        []string                    `json:"attestation_freshness_material,omitempty"`
	AttestationFreshnessBindingClaims   []string                    `json:"attestation_freshness_binding_claims,omitempty"`
	AttestationEvidenceClaimsDigest     string                      `json:"attestation_evidence_claims_digest,omitempty"`
	AttestationEvidenceDigest           string                      `json:"attestation_evidence_digest,omitempty"`
	AttestationVerifierPolicyID         string                      `json:"attestation_verifier_policy_id,omitempty"`
	AttestationVerifierPolicyDigest     string                      `json:"attestation_verifier_policy_digest,omitempty"`
	AttestationVerificationRulesVersion string                      `json:"attestation_verification_rules_version,omitempty"`
	AttestationVerificationResult       string                      `json:"attestation_verification_result,omitempty"`
	AttestationVerificationReasonCodes  []string                    `json:"attestation_verification_reason_codes,omitempty"`
	AttestationReplayVerdict            string                      `json:"attestation_replay_verdict,omitempty"`
	AttestationVerificationTimestamp    string                      `json:"attestation_verification_timestamp,omitempty"`
	AttestationVerificationDigest       string                      `json:"attestation_verification_digest,omitempty"`
