...
- Keep `workflow_routing` semantics, mutation-bearing classification, and overlap-admission consequences broker-owned and consistent across all entrypoints; clients may request routing, but they must not become the authority for whether a route is artifact-only, mutation-bearing, or overlap-safe.
