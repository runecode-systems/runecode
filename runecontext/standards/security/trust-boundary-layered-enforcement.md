...
- Route restart and resume authority through trusted broker reconciliation as well; runner-local journals, snapshots, waits, and runtime-seam checkpoints may aid recovery, but they must not overrule canonical plan or approval bindings
...
- Treat third-party runtime or framework checkpoint state the same way: useful for local mechanics, never sufficient to become planning truth, approval truth, or lifecycle truth
