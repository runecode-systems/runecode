...
- `standards/ci/windows-portability-matrix.md`

## Resolution Notes
Migrated from the legacy spec standards list and refreshed to canonical RuneContext standard paths, then expanded to keep Windows runtime work aligned with shared broker-projected posture, typed API semantics, trust-boundary enforcement, and portability matrix rules.
