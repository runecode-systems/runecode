...
- [ ] Preserve explicit identity separation among project or repository identity, repo-scoped product-instance identity, persistent ledger identity, and project-substrate snapshot identity.
- [ ] Treat persistent ledger identity as required foundation state rather than optional metadata.
...
- [ ] Ensure portable evidence semantics distinguish directly included canonical objects from transitive digest-reference dependencies.
- [ ] Harden prepared-record evidence seams for future publication durability barrier and crash-reconcile workflows without implementing federation execution behavior in this lane.
...
- [ ] RuneCode preserves persistent ledger identity as part of verification continuity across restart, migration, export, restore, and reconcile flows.
...
- [ ] RuneCode does not treat bundle manifests, preservation snapshots, or storage namespace layout as federation authority.
