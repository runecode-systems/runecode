...
## Resolution Notes
Split from `CHG-2026-011-7240-secretsd-model-gateway-v0`, kept the same trust-boundary and verification discipline standards for secrets lifecycle work, and expanded the standards list to cover lease lifecycle, trusted durable-state recovery, local-first posture, and typed control-plane contract rules.
