...
- External proving-system references are informative only. RuneCode's trusted proof contract, verification placement, and persistence semantics remain owned by this change and adjacent RuneCode assurance changes.
