...
- Follow-up review refined the implementation foundation further: performance contracts should live under `tools/perfcontracts/`, use stable fixture IDs, declare lane authority and activation state, declare threshold provenance, and include timing-boundary metadata before required enforcement.
